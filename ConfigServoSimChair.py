...
MIN_ACTUATOR_LEN  = 80
MAX_ACTUATOR_LEN =  100   # total actuator distance inclduing fixing hardware 
...
basePos     = [[m*math.cos(a),m*math.sin(a),0]  for a,m in zip(_baseAngles,_baseMagnitude)]

_platformAngles  = [math.radians(x) for x in _platformAngles]
platformPos     = [[m*math.cos(a),m*math.sin(a),0]  for a,m in zip(_platformAngles,_platformMagnitude)]
...
platform1DofLimits = [60,60,25,math.radians(25),math.radians(25),math.radians(20)] # the max movement in a single DOF 
platform6DofLimits = [30,30,12,math.radians(12),math.radians(12),math.radians(10)] # limits at extremes of movement
